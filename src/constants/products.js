/**
 * Product catalog: each entry is a sellable website product (Website A & B are both live SKUs).
 */
...
export const PRODUCT_CATALOG = [
  ...
  },
  {
    ...
    cardSummary:
      'Purpose-built for growth and product marketing: fast landings, thank-you flows, resources, and events — same product discipline as Website A, different page library.',
    heroImage:
...
/**
 * Rich detail for Website A — what the “website” actually is for buyers.
 */
export const WEBSITE_A_DETAIL = {
  slug: PRODUCT_SLUGS.WEBSITE_A,
  /** Plain-language: what you are buying */
  whatItIs: {
    title: 'What Website A is',
    lead:
      'Website A is not a vague “digital project.” It is a finished class of website: a public marketing and trust site that explains who you are, what you sell, and how to engage — with a structure we have already productized.',
    bullets: [
  ...
  pageStructure: {
    ...
    description:
      'These are the building blocks of Website A. Copy and media are yours; we implement templates, components, and CMS wiring.',
    pages: [
  ...
  included: [
    'Discovery workshop & information architecture for Website A',
  ...
  tiers: [
    {
      ...
      features: [
        'Up to 8 templates from the Website A library',
  ...
  slaPoints: [
    { title: 'Uptime target', detail: '99.9% on SCAS-managed hosting tiers for Website A' },
...
export const WEBSITE_B_DETAIL = {
  ...
  whatItIs: {
    ...
    lead:
      'Website B is a second productized website: focused on campaign velocity and conversion paths, not a full corporate IA. You get a library of landing and funnel templates, shared design tokens with your brand, and the same hosting and release rigor as Website A.',
    bullets: [
  ...
  audience: {
    ...
    items: [
      ...
      {
        title: 'Teams that already run Website A',
  ...
  techQuality: {
    title: 'Engineering & quality bar',
    items: [
      'Same modern JS stack and component discipline as Website A for brand consistency',
  ...
  included: [
    ...
    'UX/UI patterns aligned to your brand (can inherit tokens from Website A if both purchased)',
  ...
  tiers: [
    ...
    },
    {
      ...
      features: [
        ...
        'Joint roadmap with Website A where both are deployed',
        'Optional 24/7 coverage',
      ],
    },
  ],
